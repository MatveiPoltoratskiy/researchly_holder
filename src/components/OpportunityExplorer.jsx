...
const FIELD_ORDER = ['pre-med', 'biology', 'chemistry', 'physics', 'neuroscience', 'mathematics']
...
export default function OpportunityExplorer() {
  ...
  const counts = useMemo(() => {
    const c = { 'pre-med': 0, biology: 0, chemistry: 0, physics: 0, neuroscience: 0, mathematics: 0 }
