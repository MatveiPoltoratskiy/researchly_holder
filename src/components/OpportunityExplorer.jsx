...
const FIELD_META = {
  ...
  'computer-science': { label: 'Computer Science', cls: 'opp-tag--cs' },
  psychology: { label: 'Psychology', cls: 'opp-tag--psych' },
  'environmental-science': { label: 'Environmental Science', cls: 'opp-tag--envsci' },
}
...
export default function OpportunityExplorer() {
  ...
  const counts = useMemo(() => {
    const c = { 'pre-med': 0, biology: 0, chemistry: 0, physics: 0, neuroscience: 0, mathematics: 0, 'computer-science': 0, psychology: 0, 'environmental-science': 0 }
