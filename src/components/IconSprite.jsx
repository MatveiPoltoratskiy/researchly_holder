  ...
  return (
    <svg className="visually-hidden" aria-hidden="true">
      <defs>
        ...
        <symbol id="icon-people" viewBox="0 0 24 24"><circle cx="9" cy="8.2" r="3" fill="none" stroke="currentColor" strokeWidth="1.6" /><path d="M3.3 19c1-3.4 3-5 5.7-5s4.7 1.6 5.7 5" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" /><circle cx="16.4" cy="8.7" r="2.3" fill="none" stroke="currentColor" strokeWidth="1.4" /><path d="M14.9 13.4c2.3.3 3.9 1.8 4.7 4.4" fill="none" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" /></symbol>
        ...
        <symbol id="icon-pin" viewBox="0 0 24 24"><path d="M12 21.5s7-6.3 7-12A7 7 0 0 0 5 9.5c0 5.7 7 12 7 12Z" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinejoin="round" /><circle cx="12" cy="9.5" r="2.4" fill="none" stroke="currentColor" strokeWidth="1.5" /></symbol>
        <symbol id="icon-trending-up" viewBox="0 0 24 24"><path d="M4 16l6-6 4 4 6-7" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round" /><path d="M14.5 6.5H20V12" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round" /></symbol>
        ...
        <symbol id="icon-bell" viewBox="0 0 24 24"><path d="M12 3.5a1.6 1.6 0 0 0-1.6 1.6v.6C7.9 6.4 6.2 8.7 6.2 11.7v3.2L4.6 17.5a1 1 0 0 0 .9 1.5h13a1 1 0 0 0 .9-1.5l-1.6-2.6v-3.2c0-3-1.7-5.3-4.2-6v-.6A1.6 1.6 0 0 0 12 3.5Z" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinejoin="round" strokeLinecap="round" /><path d="M9.6 19.5a2.4 2.4 0 0 0 4.8 0" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" /></symbol>
        <symbol id="icon-bell-filled" viewBox="0 0 24 24"><path d="M12 3.5a1.6 1.6 0 0 0-1.6 1.6v.6C7.9 6.4 6.2 8.7 6.2 11.7v3.2L4.6 17.5a1 1 0 0 0 .9 1.5h13a1 1 0 0 0 .9-1.5l-1.6-2.6v-3.2c0-3-1.7-5.3-4.2-6v-.6A1.6 1.6 0 0 0 12 3.5Z" fill="currentColor" stroke="currentColor" strokeWidth="1.6" strokeLinejoin="round" strokeLinecap="round" /><path d="M9.6 19.5a2.4 2.4 0 0 0 4.8 0" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" /></symbol>
        <symbol id="icon-download" viewBox="0 0 24 24"><path d="M12 4v11M8 11.5l4 4 4-4" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" /><path d="M5 17v2.5A1.5 1.5 0 0 0 6.5 21h11a1.5 1.5 0 0 0 1.5-1.5V17" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" /></symbol>
        ...
        <symbol id="icon-building" viewBox="0 0 24 24"><path d="M5 20V5.5A1.5 1.5 0 0 1 6.5 4h6A1.5 1.5 0 0 1 14 5.5V20" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinejoin="round" /><path d="M14 11h4.5A1.5 1.5 0 0 1 20 12.5V20" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinejoin="round" /><path d="M3 20h18" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" /><path d="M9.5 8v2.4M8.3 9.2h2.4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" /><circle cx="17" cy="15.2" r=".9" fill="currentColor" /></symbol>
        <symbol id="icon-flask" viewBox="0 0 24 24"><path d="M10 3h4M10.5 3v5.6L5.8 17a2 2 0 0 0 1.7 3h9a2 2 0 0 0 1.7-3l-4.7-8.4V3" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinejoin="round" strokeLinecap="round" /><path d="M7.6 14.5h8.8" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" /><circle cx="10.8" cy="17.2" r=".8" fill="currentColor" /><circle cx="13.6" cy="18.2" r=".6" fill="currentColor" /></symbol>
        ...
        <symbol id="icon-dna" viewBox="0 0 24 24"><path d="M7 3c0 5 10 5 10 10s-10 5-10 10" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" /><path d="M17 3c0 5-10 5-10 10s10 5 10 10" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" /><path d="M8 6.6h8M7.3 11.4h9.4M7.3 12.6h9.4M8 17.4h8" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" /></symbol>
        <symbol id="icon-brain" viewBox="0 0 24 24"><path d="M9.5 4.2a2.6 2.6 0 0 0-2.6 2.6 2.7 2.7 0 0 0-2 3.9A2.8 2.8 0 0 0 6 15.8a2.6 2.6 0 0 0 3.5 3.3 2.5 2.5 0 0 0 4.4-1.3" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /><path d="M14.5 4.2a2.6 2.6 0 0 1 2.6 2.6 2.7 2.7 0 0 1 2 3.9 2.8 2.8 0 0 1-1.1 5.1 2.6 2.6 0 0 1-3.5 3.3A2.5 2.5 0 0 1 9.9 17V6.4c0-1.2.9-2.2 2-2.2" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /></symbol>
        <symbol id="icon-code" viewBox="0 0 24 24"><path d="M9 7 4 12l5 5M15 7l5 5-5 5" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" /></symbol>
        <symbol id="icon-mic" viewBox="0 0 24 24"><rect x="9" y="3" width="6" height="11" rx="3" fill="none" stroke="currentColor" strokeWidth="1.7" /><path d="M6 11.5a6 6 0 0 0 12 0" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" /><path d="M12 17.5V21M8.5 21h7" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" /></symbol>
        <symbol id="icon-waveform" viewBox="0 0 24 24"><path d="M3 12v0M7 8v8M11 4v16M15 8v8M19 12v0M21 10v4" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" /></symbol>
        {/* generic institution "crest" for hero showcase cards — an abstract shield
            silhouette + initial, never a real school seal/logo, so a program still reads
            as "a real institution" without any trademark risk */}
        <symbol id="crest-shield" viewBox="0 0 24 24"><path d="M12 2.5 19.5 5.5V11.5C19.5 16.2 16.3 20 12 21.5C7.7 20 4.5 16.2 4.5 11.5V5.5Z" fill="currentColor" /></symbol>
